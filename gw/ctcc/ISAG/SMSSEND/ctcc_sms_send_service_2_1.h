/* ctcc_sms_send_service_2_1.h
   Generated by wsdl2h 1.2.17 from ctcc_sms_send_service_2_1.wsdl and typemap.dat
   2010-07-30 06:52:10 GMT
...
Operation details:
  ...
  - SOAP Fault: "http://www.chinatelecom.com.cn/schema/ctcc/common/v2_1":ServiceException (literal)

  - SOAP Fault: "http://www.chinatelecom.com.cn/schema/ctcc/common/v2_1":PolicyException (literal)
...
int __ns1__sendSms(
    struct ns2__sendSms*                ns2__sendSms,	///< Request parameter
    struct ns2__sendSmsResponse*        ns2__sendSmsResponse	///< Response parameter
);
...
int __ns1__sendSmsLogo(
    struct ns2__sendSmsLogo*            ns2__sendSmsLogo,	///< Request parameter
    struct ns2__sendSmsLogoResponse*    ns2__sendSmsLogoResponse	///< Response parameter
);
...
int __ns1__sendSmsRingtone(
    struct ns2__sendSmsRingtone*        ns2__sendSmsRingtone,	///< Request parameter
    struct ns2__sendSmsRingtoneResponse* ns2__sendSmsRingtoneResponse	///< Response parameter
);
...
int __ns1__getSmsDeliveryStatus(
    struct ns2__getSmsDeliveryStatus*   ns2__getSmsDeliveryStatus,	///< Request parameter
    struct ns2__getSmsDeliveryStatusResponse* ns2__getSmsDeliveryStatusResponse	///< Response parameter
);
